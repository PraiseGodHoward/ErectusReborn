...
#include "ini.h"
	...
	//Offsets
#define OFFSET_LOCAL_PLAYER                             0x05B0A458UL//1.3.1.34
#define OFFSET_ENTITY_LIST                              0x058E6F78UL//1.3.1.34
#define OFFSET_MAIN                                     0x05B6A150UL//1.3.1.34
#define OFFSET_CAMERA                                   0x06B15C00UL//1.3.1.34
#define OFFSET_CHAR_CONTROLLER                          0x05D62590UL//1.3.1.34
#define OFFSET_GET_PTR_A1                               0x058ED128UL//1.3.1.34
#define OFFSET_GET_PTR_A2                               0x03CA9130UL//1.3.1.34
#define OFFSET_MESSAGE_SENDER                           0x0148B000UL//1.3.1.34
#define OFFSET_FAKE_MESSAGE                             0x0140720EUL//1.3.1.34
#define OFFSET_DATA_HANDLER                             0x058E36C8UL//1.3.1.34
#define OFFSET_INFINITE_AMMO                            0x00CFA5F6UL//1.3.1.34
#define OFFSET_REDIRECTION                              0x017FAD46UL//1.3.1.34
#define OFFSET_REDIRECTION_JMP                          0x017FABB4UL//1.3.1.34
#define OFFSET_NOCLIP_A                                 0x02965558UL//1.3.1.34
#define OFFSET_NOCLIP_B                                 0x02965510UL//1.3.1.34
#define OFFSET_NOCLIP_C                                 0x01602D91UL//1.3.1.34
#define OFFSET_NOCLIP_D                                 0x01602DC1UL//1.3.1.34
...
#define OFFSET_NPC_PTR_FUNCTION                         0x00440E90UL//1.3.1.34
#define OFFSET_MELEE_ATTACK                             0x0168CE50UL//1.3.1.34
#define OFFSET_CHARGEN                                  0x05B0CD60UL//1.3.1.34


//vtables
#define VTABLE_TESNPC                                   0x038ACBA0UL//1.3.1.34
#define VTABLE_TESOBJECTCONT                            0x0382F4B0UL//1.3.1.34
#define VTABLE_TESOBJECTMISC                            0x038318A0UL//1.3.1.34
#define VTABLE_TESOBJECTBOOK                            0x0382E7A0UL//1.3.1.34
#define VTABLE_ALCHEMYITEM                              0x0377A4A0UL//1.3.1.34
#define VTABLE_TESAMMO                                  0x03822238UL//1.3.1.34
#define VTABLE_TESOBJECTWEAP                            0x03839E78UL//1.3.1.34
#define VTABLE_TESOBJECTARMO                            0x0382D918UL//1.3.1.34
#define VTABLE_TESUTILITYITEM                           0x0383BD50UL//1.3.1.34
#define VTABLE_BGSNOTE                                  0x038A2330UL//1.3.1.34
#define VTABLE_TESKEY                                   0x03826DF0UL//1.3.1.34
#define VTABLE_TESFLORA                                 0x03823F58UL//1.3.1.34
#define VTABLE_TESLEVITEM                               0x038281B0UL//1.3.1.34
#define VTABLE_CURRENCYOBJECT                           0x03820BA8UL//1.3.1.34
#define VTABLE_REQUESTACTIVATEREFMSG                    0x03AE4E80UL//1.3.1.34
#define VTABLE_REQUESTTRANSFERITEMMSG                   0x03AF8FC8UL//1.3.1.34
#define VTABLE_REQUESTTELEPORTTOLOCATIONMSG             0x03AED030UL//1.3.1.34
#define VTABLE_CLIENTSTATEMSG                           0x03AECC10UL//1.3.1.34
#define VTABLE_REQUESTHITSONACTORS                      0x03AE4AB0UL//1.3.1.34
#define VTABLE_CREATEPROJECTILEMESSAGECLIENT            0x03AE8A38UL//1.3.1.34
