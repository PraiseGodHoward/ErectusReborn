...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
	...
	WindowClassEx.lpszClassName = "D00bieCLS";
	...
	WindowHwnd = CreateWindowEx(WS_EX_TRANSPARENT | WS_EX_LAYERED, WindowClassEx.lpszClassName, random_string(16).c_str(), WS_POPUP, WindowPosition[0], WindowPosition[1], WindowSize[0], WindowSize[1], NULL, NULL, WindowClassEx.hInstance, NULL);
